...
if args.render:
    ...
    if args.viz_output is not None:
        ...
        np.save(args.viz_output, prediction)
...
最终输出为 prediction
提取命令 
python run_output3d.py `
    -d custom -k myvideos `
    -arc 3,3,3,3,3 -c checkpoint `
    --evaluate pretrained_h36m_detectron_coco.bin `
    --render --viz-subject 1.mp4 `
    --viz-action custom `
    --viz-camera 0 `
    --viz-video C:\\Users\\ao\\Desktop\\detect\\test\\1.mp4 `
    --viz-output C:\\Users\\ao\\Desktop\\detect\\test\\1outp.mp4 `
    --viz-size 6
"""
